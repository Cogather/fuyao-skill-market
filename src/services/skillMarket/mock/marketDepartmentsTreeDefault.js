...
function nestPathsToDepartmentDtos(paths) {
    const root = { name: '', level: 0, children: new Map() };
...
export function getMockMarketDepartmentsTree() {
