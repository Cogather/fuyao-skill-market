...
export function validateProductCatalogItemName(value: string, productName: string): string {
...
export const validateScenarioCreationCode = validateProductCatalogItemName;
